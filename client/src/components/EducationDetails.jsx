...
const EducationDetails = ({darkMode}) => {
    return (
        <motion.section 
            ...
            id='education'
            className={`p-4 ${darkMode ? 'bg-[#0D1117]' : 'bg-red-50'} grid gap-6`}
        >
                    ...
                    return (
                        ...
                        <div className='flex items-center justify-center gap-6 mb-4'>
                                ...
                                <div className='flex items-center justify-between'>
                                    ...
                                    <div className='w-0 h-0 border-t-8 border-b-8 border-l-8 border-t-transparent border-b-transparent bg-l-black text-black'></div>
                                </div>
